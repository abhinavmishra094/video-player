...
<!---->
		<div class="product">
		 ...
		 <ul class="menu">
		<li class="item1"><a href="#">Hardisk </a>
			<ul class="cute">
				<li class="subitem1"><a href="#">Internal Hard Disk </a></li>
				<li class="subitem2"><a href="#">External Hard Disk </a></li>
				<li class="subitem3"><a href="#">SSD </a></li>
			</ul>
		</li>
		<li class="item2"><a href="#">Mobiles </a>
			<ul class="cute">
				<li class="subitem1"><a href="#">Samsung  </a></li>
				<li class="subitem2"><a href="#">Apple </a></li>
				<li class="subitem3"><a href="#">L.G </a></li>
			</ul>
		</li>
		<li class="item3"><a href="#">Flash Storage</a>
			<ul class="cute">
				<li class="subitem1"><a href="#">S.D Cards </a></li>
				<li class="subitem2"><a href="#">Pen Drives </a></li>
				<li class="subitem3"><a href="#">S.S.D</a></li>
			</ul>
		</li>
		<li class="item4"><a href="#">C.P.U</a>
			<ul class="cute">
				<li class="subitem1"><a href="#">Intel </a></li>
				<li class="subitem2"><a href="#">AMD </a></li>
				<li class="subitem3"><a href="#">Nvidia</a></li>
			</ul>
		</li>
				
		<li class="item4"><a href="#">Mouse & Keyboard</a>
			<ul class="cute">
				<li class="subitem1"><a href="#"> Logitech</a></li>
				<li class="subitem2"><a href="#">I Ball</a></li>
				<li class="subitem3"><a href="#">Cross Air </a></li>
			</ul>
		</li>
	</ul>
					</div>
				...
				<div class="product-bottom">
					...
					<div class="product-go">
						<div class=" fashion-grid">
                                                    <a href="#"><img class="img-responsive " src="images/6s.png" alt=""></a>
									
								</div>
							<div class=" fashion-grid1">
								<h6 class="best2"><a href="#" >I Phone 6s
amet consectetuer  </a></h6>
								
								<span class=" price-in1"> $649</span>
							</div>
...
<div class=" per1">
				...
				<!--Custom Theme files--> <div class="col-md-9 product-price1">
...
<div class="clearfix"></div>
		...
		<div class=" bottom-product">
                                                    ...
                                                    PreparedStatement ps= con.prepareStatement("Select * from product where product_id='"+i+"' ");
